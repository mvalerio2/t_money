//package com.simulator.tmoney.scheduler;
//
...
//
//import com.simulator.tmoney.config.AutoWiringSpringBeanJobFactory;
...
//
//        return newJob().ofType(ConsultarCriptomoeda.class).storeDurably().withIdentity(JobKey.jobKey("Qrtz_Job_Detail")).withDescription("Invoke Sample Job service...").build();
//    }
//
//    @Bean
